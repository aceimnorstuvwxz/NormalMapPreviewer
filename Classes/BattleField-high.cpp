...
void BattleHighNode::configBuildingAnimation(const std::string& buildingFile)
{
    _textureBuildingAnimation = Director::getInstance()->getTextureCache()->addImage(buildingFile);
}
